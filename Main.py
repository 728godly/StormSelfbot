...
async def on_ready():
    ...
    print()
    print(Fore.CYAN + "╔══════════════════════════════╗")
    print(f"  Welcome: {Fore.GREEN}{client.user.name}               ")
    print(f"  Prefix: {Fore.GREEN}{prefix}                    ")
    print(f"  ID: {Fore.GREEN}{client.user.id}       ")
    print(f"  Discord Version: {Fore.GREEN}{discord.__version__}       ")
    print(f"  Storm Version: {Fore.GREEN}0.2.4")
    print("{Fore.CYAN}╚══════════════════════════════╝")
    print(Fore.GREEN + "╔══════════════════════════════╗")
    print("║           Console            ║")
    print("╚══════════════════════════════╝")
