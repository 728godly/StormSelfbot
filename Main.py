...
async def on_ready():
    ...
    print()
    print(Fore.CYAN + "╔══════════════════════════════╗")
    print(f"  {Fore.BLUE}Welcome: {Fore.GREEN}{client.user.name}               ")
    print(f"  {Fore.BLUE}Prefix: {Fore.GREEN}{prefix}                    ")
    print(f"  {Fore.BLUE}ID: {Fore.GREEN}{client.user.id}       ")
    print(f"  {Fore.BLUE}Discord Version: {Fore.GREEN}{discord.__version__}       ")
    print(f"  {Fore.BLUE}Storm Version: {Fore.GREEN}0.2.4")
    print(f"{Fore.CYAN}╚══════════════════════════════╝")
    print(Fore.GREEN + "╔══════════════════════════════╗")
    print("║           Console            ║")
    print("╚══════════════════════════════╝")
